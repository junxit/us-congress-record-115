---
granule: CRECB-2018-pt6-Pg7542-2
date: 2018-05-17
edition: CRECB
section: HOUSE
page: 7542
...
printed in House Report 115-679.
  ...
  The text of the amendment is as follows:
     ...
     grant universities, and extension services through the John 
     Ogonowski and Doug Bereuter Farmer-To-Farmer Program under 
...
work. Their family households, therefore, will have less of a food 
allowance. That will impact these kids. That is undeniable.
...
harmless and that kids won't suffer. It is just not true. I mean, read 
the CBO score. Better yet, read the bill.
...
printed in House Report 115-679.
  ...
  The text of the amendment is as follows:
     ...
     SEC. ___. DISQUALIFICATION OF CERTAIN CONVICTED FELONS.
...
to H.R. 2 at the desk.
  ...
  The text of the amendment is as follows:
     ...
     SEC. ___. DETERMINATION OF AMOUNT OF BLOCK GRANT PAYABLE TO 
                   PUERTO RICO.
...
by the rule.
  ...
  The text of the amendment is as follows:
     ...
     SEC. ___. ADMINISTRATIVE FLEXIBILITY FOR STATES.
...
and all of these other programs--which the

[[Page 7547]]

gentleman supports already--permit doing precisely what I am suggesting 
...
privatization.
  In the early 2000s Texas transferred most of the operational aspects 
...
and accurate provision of benefits.
  During the early 2000s, Texas experimented with privatizing key 
...
same as it does, as current law does, for TANF, for a host of other 
social services programs, and for CHIP.
...
[[Page 7548]]
  ...
  The text of the amendment is as follows:
     ...
     SEC. ___. SERVICE OF TRADITIONAL FOODS IN PUBLIC FACILITIES.
...
at the desk.
  ...
  The text of the amendment is as follows:
     ...
     SEC. ___. EXTENSION OF STUDY ON COMPARABLE ACCESS TO 
...
national security issue--but they also create jobs and investments that 
bring these benefits to our rural communities, our States, and our 
country. Not only that, but they also create new demand for many 
...
gentleman from California (Mr. McClintock) on which further proceedings 
