...
Republican-controlled Congress, last term, went to great lengths to 
talk about the potential damage of having a private email server for 
Secretary of State Hillary Clinton. This is a very similar concept. 
These are cell phones from which foreign powers can get the actual 
conversations of the President of the United States.
...
also from multiple media outlets, is that this President is using a 
phone that is potentially compromising national security.
