---
granule: CRECB-2018-pt9-Pg11727-2
date: 2018-06-28
edition: CRECB
section: EXTENSIONS
page: 11727
...
society is truly made richer and stronger by immigrants.
     ...
     ger is used, which can translate to ``immigrant'' OR 
     ``convert''. In the middle ages Rabbis interpreted ger as 
     convert, so the Torah might be saying that you should treat 
     converts to Judaism nicely INSTEAD of saying that Jews should 
     treat all strangers well.
     ...
     During the Holocaust when many Jews

[[Page 11728]]

     needed a safe place, FDR and Congress turned them away. 
     Congress turned down a bill that would have allowed 20,000 
     Jewish children from Germany to find safe haven in the U.S. 
     Furthermore, when a ship with about 1,000 Jewish people 
     trying to escape persecution tried to enter the United States 
     it was turned away. After the ship was turned away TWICE it 
     sailed back to Europe where many of the Jews were caught and 
     ...
     Furthermore, immigrant-headed households who are close to the 
