...
the Record, as follows:
    ...
    (By Jim Inhofe, Sheldon Whitehouse, Mike Crapo and Cory Booker)
     ...
     fired combined-cycle power plant. This is causing some 
     nuclear energy companies to scale back their operations. For 
     instance, Chicago-based Exelon Corporation announced just a 
     few weeks ago that it would shutter two of its nuclear plants 
     in Illinois in the coming years, citing pressure from natural 
