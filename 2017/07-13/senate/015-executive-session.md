---
granule: CRECB-2017-pt8-Pg10768-2
date: 2017-07-13
edition: CRECB
section: SENATE
page: 10768
...
CO<INF>2</INF> emissions and what those emissions are doing 
environmentally.
...
CO<INF>2</INF>--those credits have proved to be, albeit used, but 
...
challenge in natural gas, and the ability to capture CO<INF>2</INF> 
...
technology, CO<INF>2</INF> is going to have another use out there. 
...
their waste energy, their waste CO<INF>2</INF>, their wastewater all 
into a plant that grows algae, and the algae eats up the 
CO<INF>2</INF>. They take about 15 percent of it out of the stream, and 
...
taken the SO<INF>X</INF> and the NO<INF>X</INF> and the mercury out and 
...
Can it be solidified? We know we can take clear stream CO<INF>2</INF> 
off. Can we solidify this CO<INF>2</INF>? It would not just be 
...
solids, can we use the spent fuel of a solid carbon, CO<INF>2</INF>?
...
mercury.
  It is not CO<INF>2</INF> killing people in Beijing; it is basically 
...
produce a salable and lucrative byproduct--CO<INF>2</INF>--which can be 
...
formations. This is not a technology, CO<INF>2</INF> flooding isn't a 
...
where they inject the CO<INF>2</INF>. They basically let that sit in 
