...
# PROVIDING FOR CONSIDERATION OF S.J. RES. 34, PROVIDING FOR CONGRESSIONAL DISAPPROVAL OF A RULE SUBMITTED BY THE FEDERAL COMMUNICATIONS COMMISSION
...
a basic level of transparency that helps ensure the public's interest 
is placed first. The American people deserve the same level of 
...
that is, well, what about Google and Netflix and Facebook? What about 
them? Why aren't they subject to what the FCC did? Well, they are edge 
providers. They are edge providers.
...
access, and that is the case for most American families.
...
a nature where it is saleable, but it is just their business?

[[Page 4963]]

Well, somebody else is going to know now. And they may well be able to 
...
[[Page 4964]]
     ...
     rules, ISPs could use and disclose customer information at 
     will. The result could be extensive harm caused by breaches 
     or misuse of data.
...
the same time, they want to eliminate the requirements of cybersecurity 
...
Rules.''
     ...
     rules in the hope that

[[Page 4966]]

     it would follow the FTC's successful sensitivity-based 
     framework.
