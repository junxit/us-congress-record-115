---
granule: CREC-2017-07-18-pt1-PgH5927-3
date: 2017-07-18
edition: CREC
section: HOUSE
page: H5927
...
**Speaking:** Burgess, Michael C. (B001248) [R-TX], Polis, Jared (P000598) [D-CO], Connolly, Gerald E. (C001078) [D-VA], DeFazio, Peter A. (D000191) [D-OR]

**Measures:** H.Res. 451, H.R. 806, H.R. 2510
...
[[Page H5932]]
     ...
     (NO<INF>X</INF>), which CASAC has also been reviewing, on 
     ...
     reductions in nitrogen oxides (NO<INF>X</INF>) emissions will 
     ...
     NO<INF>X</INF> emissions from existing levels, the HREA found 
     ...
     other words, even though reducing NO<INF>X</INF> emissions 
     may yield direct benefits by reducing NO<INF>X</INF> related 
     ...
     NO<INF>X</INF> emission reductions on ozone levels throughout 
     ...
     during the cooler months of the year when NO<INF>X</INF> 
     emissions are reduced. This March testimony reported that 
     such a full year-round analysis of the impact of 
     NO<INF>X</INF> emission reductions in urban Philadelphia 
     ...
     evaluated when nationwide NO<INF>X</INF> emissions were cut 
     ``almost in half,'' but fails to address how increases in 
     wintertime ozone levels from further NO<INF>X</INF> 
     ...
     effect of further NO<INF>X</INF> emission reductions on the 
     epidemiologically-based, short-term mortality and morbidity 
